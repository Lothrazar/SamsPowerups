...
public class BigInventoryPlayer extends InventoryPlayer
{
	...
	{
		super(player);
		this.mainInventory = new ItemStack[Const.INV_SIZE + Const.hotbarSize];
...
//TODO: these ifelse brnaches are almost all identical. find a way to share code? make function?
    ...
    {
        this.mainInventory = new ItemStack[MathHelper.clamp_int(Const.INV_SIZE, 27, Integer.MAX_VALUE - 100) + 9];
