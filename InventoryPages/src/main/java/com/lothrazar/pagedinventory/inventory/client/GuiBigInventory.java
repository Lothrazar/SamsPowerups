...
import com.lothrazar.pagedinventory.ModConfig;
import com.lothrazar.pagedinventory.inventory.BigContainerPlayer;
    ...
    { 
	 ...
	 /*
			...
			*/
			...
			{
				btnPages[pg] = new GuiButtonPage(button_id++, x, y,width,height, pg,""+(pg+1));
