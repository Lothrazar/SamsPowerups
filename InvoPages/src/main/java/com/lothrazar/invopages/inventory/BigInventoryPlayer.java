package com.lothrazar.invopages.inventory;
...
public class BigInventoryPlayer extends InventoryPlayer
{
	...
	{
		super(player);
		this.mainInventory = new ItemStack[Const.INVO_SIZE + Const.hotbarSize];
...
//TODO: these ifelse brnaches are almost all identical. find a way to share code? make function?
    ...
    {
        this.mainInventory = new ItemStack[MathHelper.clamp_int(Const.INVO_SIZE, 27, Integer.MAX_VALUE - 100) + 9];
