...
public class ModMain
{
	...
	//nope this is read only, you CANNOT create the file from here. now i know.
	private void initModInfo(ModMetadata mcinfo)
	{ 
		//System.out.println("=======================");
		//System.out.println(mcinfo.version);
		...
		mcinfo.authorList.add("Lothrazar");// = authorList;
		mcinfo.autogenerated = true;
//mcinfo.updateUrl
		mcinfo.credits = "credits";
